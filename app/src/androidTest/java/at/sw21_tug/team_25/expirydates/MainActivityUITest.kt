        ...
        val textView2 = onView(
                allOf(withId(R.id.largeLabel), withText("Home"),
                        withParent(allOf(withId(R.id.labelGroup),
                                withParent(allOf(withId(R.id.navigation_home), withContentDescription("Home"))))),
                        isDisplayed()))
        textView2.check(matches(withText("Home")))

        val textView3 = onView(
                allOf(withId(R.id.smallLabel), withText("Add"),
                        withParent(allOf(withId(R.id.labelGroup),
                                withParent(allOf(withId(R.id.navigation_add), withContentDescription("Add"))))),
                        isDisplayed()))
        textView3.check(matches(withText("Add")))

        val textView4 = onView(
                allOf(withId(R.id.smallLabel), withText("List"),
                        withParent(allOf(withId(R.id.labelGroup),
                                withParent(allOf(withId(R.id.navigation_list), withContentDescription("List"))))),
                        isDisplayed()))
